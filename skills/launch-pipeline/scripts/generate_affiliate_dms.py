...
TEMPLATES = [
    (
        ...
        "launched -- {product_name} (${price}). I'm offering {commission}% commission "
        "on every sale through your own affiliate link (that's ${commission_amount:.0f}"
        "/sale on a ${price} product), no cost to you to promote. Takes 2 min to set up "
        "an affiliate account here: {affiliate_link}. Want me to send a couple of "
        "ready-to-post clips too?"
    ),
    (
        "Hi -- quick one. I run {product_name}, a ${price} product. Looking for a few "
        "accounts like yours to partner with as affiliates -- {commission}% commission "
        "per sale, your own tracked link via Payhip: {affiliate_link}. Takes 2 minutes "
        "to join, no upfront cost. Let me know if you want the details or a sample post "
        "to work from."
    ),
    (
        "Hey! Loved {niche_clause} -- mind if I send over a quick collab idea? I've got "
        "{product_name} (${price}) that fits your audience, and I'm running "
